namespace CMS.Domain.Specification
{
    using System;
    using System.Linq;
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="CMS.Domain.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="CMS.Domain.Specification.ISpecification{TEntity}"/></returns>
